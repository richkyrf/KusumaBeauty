 ...
 * @author richky
 */
public class ListMasterPasien extends javax.swing.JFrame {

    /**
     * Creates new form ListKaryawan
     */
    public ListMasterPasien() {
        initComponents();
        setVisible(true);
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        GlobalVar.Var.listMasterPasien = null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListMasterPasien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListMasterPasien().setVisible(true);
            }
        });
    }
    ...
    void tambah() {
        if (GlobalVar.Var.tambahMasterPasien == null) {
            GlobalVar.Var.tambahMasterPasien = new MasterPasien();
        }
    }
    ...
    void hapus() {
        if (jcomCari1.getSelectedRow() < 0) {
            ...
            Boolean berhasil = delete.Hapus(jcomCari1.GetIDTable(), "DELETE FROM `tbmpasien` WHERE `IdPasien` = " + jcomCari1.GetIDTable(), "Pasien", this);
            if (berhasil) {
                refreshAll();
            }
        }
    ...
    void ubah() {
        if (jcomCari1.getSelectedRow() < 0) {
            ...
            if (GlobalVar.Var.ubahMasterPasien == null) {
                GlobalVar.Var.ubahMasterPasien = new MasterPasien(jcomCari1.GetIDTable());
            } else {
                GlobalVar.Var.ubahMasterPasien.setState(NORMAL);
                GlobalVar.Var.ubahMasterPasien.toFront();
            }
        }
    }

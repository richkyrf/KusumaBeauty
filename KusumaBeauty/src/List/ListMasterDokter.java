 ...
 * @author richky
 */
public class ListMasterDokter extends javax.swing.JFrame {

    /**
     * Creates new form ListKaryawan
     */
    public ListMasterDokter() {
        initComponents();
        setVisible(true);
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        GlobalVar.Var.listMasterDokter = null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListMasterDokter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListMasterDokter().setVisible(true);
            }
        });
    }
    ...
    void tambah() {
        if (GlobalVar.Var.tambahMasterDokter == null) {
            GlobalVar.Var.tambahMasterDokter = new MasterDokter();
        }
    }
    ...
    void hapus() {
        if (jcomCari1.getSelectedRow() < 0) {
            ...
            Boolean berhasil = delete.Hapus(jcomCari1.GetIDTable(), "DELETE FROM `tbmdokter` WHERE `IdDokter` = " + jcomCari1.GetIDTable(), "Dokter", this);
            if (berhasil) {
                refreshAll();
            }
        }
    ...
    void ubah() {
        if (jcomCari1.getSelectedRow() < 0) {
            ...
            if (GlobalVar.Var.ubahMasterDokter == null) {
                GlobalVar.Var.ubahMasterDokter = new MasterDokter(jcomCari1.GetIDTable());
            } else {
                GlobalVar.Var.ubahMasterDokter.setState(NORMAL);
                GlobalVar.Var.ubahMasterDokter.toFront();
            }
        }
    }
